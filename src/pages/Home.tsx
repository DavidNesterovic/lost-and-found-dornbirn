...
import {getFoundItems} from "../api/foundItemsApi";
...
const Home = () => {
    ...
    useEffect(() => {
        const fetchRecentItems = async () => {
            try {
                const data = await getFoundItems(3);
                setRecentItems(data);
            } catch (error) {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 pb-12">
            <div className="text-center pt-12 sm:pt-20">
                ...
                <div
                    className="mt-10 mx-auto max-w-md w-full flex flex-row items-center justify-center gap-4 sm:gap-x-6 sm:w-auto">
                    <Link
                        to="/lost"
                    ...
                    >
                        ...
                        <span className="hidden sm:inline">Ich habe etwas gefunden <span
            ...
            <div className="mx-auto max-w-7xl px-0 sm:px-6 lg:px-8 mt-16">
                <div className="bg-slate-50 rounded-3xl p-8 sm:p-16 shadow-lg ring-1 ring-gray-900/5">
                    <div className="mx-auto max-w-2xl text-center">
                        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">So
                            funktioniert's</h2>
                    ...
                    <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
                        <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <dt className="text-base font-semibold leading-7 text-gray-900">1. Suchen oder Melden
                                </dt>
                                <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                                    <p className="flex-auto">Durchsuche die Liste der gefundenen Gegenstände oder
                                        erstelle einen neuen Eintrag.</p>
                                </dd>
                            </div>
                            ...
                            <div className="flex flex-col items-center text-center">
                                ...
                                <dt className="text-base font-semibold leading-7 text-gray-900">2. Kontakt aufnehmen
                                </dt>
                                <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                                    <p className="flex-auto">Schreibe dem Finder oder Eigentümer über die Plattform oder
                                        E-Mail.</p>
                                </dd>
                            </div>
                            ...
                            <div className="flex flex-col items-center text-center">
                                ...
                                <dt className="text-base font-semibold leading-7 text-gray-900">3. Gegenstand
                                    zurückerbekommen
                                </dt>
                                <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                                    <p className="flex-auto">Trefft euch an einem sicheren Ort, um den Gegenstand
                                        zurückzugeben oder abzuholen.</p>
                                </dd>
                            </div>
                        </dl>
                    </div>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 mt-16 mb-24">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <Link to="/found"
                          className="text-md font-semibold text-blue-600 hover:text-blue-400 transition-colors">
                        Alle ansehen <span aria-hidden="true">→</span>
                    </Link>
                </div>

                {loading ? (
                    <p className="text-sm text-gray-500">Lade Einträge...</p>
                ) : (
